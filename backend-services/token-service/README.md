...
- [API Reference](#api-reference)
  ...
  - [User Context Token Endpoint](#2-user-context-token-endpoint)
  - [JWKS Endpoint](#3-jwks-endpoint)
...
# 2. Restart service (loads both keys, still signs with old)

# 3. Update ACTIVE_KEY_ID and restart
