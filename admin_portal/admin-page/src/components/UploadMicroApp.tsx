...
function isZipMagic(buf: ArrayBuffer | null | undefined): boolean {
...
async function validateZipFile(file: File | null): Promise<{ ok: boolean; message?: string }> {
...
function safeServerMessage(payload: unknown, fallback: string): string {
  try {
